# Django settings for opendata_tools_org project.
import os, sys
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'opendata_tools_org', 'sqlite3.db'), # Or path to database file if using sqlite3.
...
ALLOWED_HOSTS = ['.opendata-tools.org',]
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'opendata_tools_org', 'media')
...
ROOT_URLCONF = 'opendata_tools_org.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'opendata_tools_org.wsgi.application'
...
HAYSTACK_CONNECTIONS = {
    'default': {
        ...
        'PATH': os.path.join(BASE_DIR, 'opendata_tools_org', 'search_index'),
    },
}
